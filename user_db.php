<html>  
    ...
    <body>
        ...
        <table>
                ...
                if($result->num_rows>0)
                {
                    ...
                    while($row = $result->fetch_assoc())
                    {
                        if($count<4)
                        {
                            ...
                            $edit6[$i] = $row["image"];
                            $edit8[$i] = $row["status"]; 
                            echo "<tr><td class='cid'>".$row["complaintid"]."</td><td>".$row['authorityname']."</td><td class='cid'>".$row['status']."</td></tr>";
                            $i++;
                            $count++;
                        }
                    }
            ...
            <a href="user_complaints.php">
                    <button name="view comp" >View more &raquo</button>
            </a>
            <div class="add">
                <form action="add_complaint.php" method="post">
                    <input type="submit" value="ADD COMPLAINT" class="addinput">
                </form>
            </div>
        </div>
            <div class='main1'>
